...
\Page{
	...
	\Explain{
			...
			$
				(\sigma,f)^\#_X(v + w) = 
				\inf_{x,\lambda} \sigma( v + w + \lambda x) -   \lambda f(x)  \le 
				\inf_{x,\lambda} \sigma\left( v + \frac{\lambda}{2} x\right) -   \frac{\lambda}{2} f(x) 
				+  \sigma\left( w + \frac{\lambda}{2} x\right) -   \frac{\lambda}{2} f(x) 
			$
	}
\NoProof
}\Page{
